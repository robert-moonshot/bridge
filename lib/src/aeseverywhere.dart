...
/// A class that provides AES-256 encryption and decryption functionality.
class Aes256 {
  ...
  /// Decrypts the given [encoded] text using the provided [passphrase].
  ///
  /// Returns the decrypted text as a string, or `null` if decryption fails.
